...
//      1.横向扩展：如需给当前控制器添加API，请在控制器类型 MatBasedataController.cs 进行添加
//      2.纵向扩展：如需要重写当前控制器的API实现，请在控制器类型 MatBasedataController.cs 进行继承重写
// </auto-generated>
//
//  <copyright file="MatBasedataBase.generated.cs" company="teng.kun">
//      teng.kun
//  </copyright>
...
namespace teng.kun.Web.Areas.Admin.Controllers
{
    ...
    public abstract class MatBasedataControllerBase : AdminApiController
    {
        ...
        /// </summary>
        protected MatBasedataControllerBase(IBaseModuleContract baseModuleContract,
        ...
        /// 新增物品基础数据信息
        /// </summary>
        /// <param name="dtos">物品基础数据信息输入DTO</param>
        ...
        [ServiceFilter(typeof(UnitOfWorkAttribute))]
        [Description("新增")]
        public virtual async Task<AjaxResult> Create(MatBasedataInputDto[] dtos)
        {
            Check.NotNull(dtos, nameof(dtos));
            OperationResult result = await BaseModuleContract.CreateMatBasedatas(dtos);
        ...
        [ServiceFilter(typeof(UnitOfWorkAttribute))]
        [Description("更新")]
        public virtual async Task<AjaxResult> Update(MatBasedataInputDto[] dtos)
        {
            Check.NotNull(dtos, nameof(dtos));
            OperationResult result = await BaseModuleContract.UpdateMatBasedatas(dtos);
            return result.ToAjaxResult();
        }
        ...
        /// 删除物品基础数据信息
        /// </summary>
        /// <param name="ids">物品基础数据信息编号</param>
        /// <returns>JSON操作结果</returns>
        [HttpPost]
        [ModuleInfo]
        [DependOnFunction("Read")]
        ...
        public virtual async Task<AjaxResult> Delete(int[] ids)
        {
            ...
            OperationResult result = await BaseModuleContract.DeleteMatBasedatas(ids);
            return result.ToAjaxResult();
        }
    }
}
