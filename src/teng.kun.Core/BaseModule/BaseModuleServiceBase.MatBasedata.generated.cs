...
//      1.横向扩展：如需给当前实体 MatBasedata 添加方法，可新建文件“BaseModuleServiceBase.MatBasedata.cs”的分部类“public abstract partial class BaseModuleServiceBase”添加功能
//      2.纵向扩展：如需要重写当前实体 MatBasedata 的业务实现，可新建文件“BaseModuleService.MatBasedata.cs”的分部类“public partial class BaseModuleService”对现有方法进行方法重写实现
// </auto-generated>
//
//  <copyright file="BaseModuleServiceBase.MatBasedata.generated.cs" company="teng.kun">
//      teng.kun
//  </copyright>
...
namespace teng.kun.BaseModule
{
    public abstract partial class BaseModuleServiceBase
    {
        ...
        /// 获取 物品基础数据信息查询数据集
        /// </summary>
        public IQueryable<MatBasedata> MatBasedatas
        {
            get { return MatBasedataRepository.QueryAsNoTracking(); }
        }
        ...
        public virtual Task<OperationResult> CreateMatBasedatas(params MatBasedataInputDto[] dtos)
        {
