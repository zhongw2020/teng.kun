...
//      1.横向扩展：如需添加额外的属性，可新建文件“CusBasedataInputDto.cs”的分部类“public partial class CusBasedataInputDto”}添加属性
// </auto-generated>
//
//  <copyright file="CusBasedataInputDto.generated.cs" company="teng.kun">
//      teng.kun
//  </copyright>
...
namespace teng.kun.BaseModule.Dtos
{
    ...
    /// 输入DTO：客户基础数据信息
    /// </summary>
    [MapTo(typeof(CusBasedata))]
    [Description("客户基础数据信息")]
    public partial class CusBasedataInputDto : IInputDto<int>
    {
        /// <summary>
        /// 获取或设置 编号
        /// </summary>
