...
//      1.横向扩展：如需添加额外的属性，可新建文件“InStor.cs”的分部类“public partial class InStor”}添加属性
// </auto-generated>
//
//  <copyright file="InStor.generated.cs" company="teng.kun">
//      teng.kun
//  </copyright>
...
namespace teng.kun.InStorManager.Entities
{
    /// <summary>
    /// 实体类：入库信息
    /// </summary>
    [Description("入库信息")]
    [TableNamePrefix("InStorManager")]
    public partial class InStor : EntityBase<int>, ICreationAudited<int>, IUpdateAudited<int>
    {
        /// <summary>
        /// 获取或设置 入库凭证号
        /// </summary>
