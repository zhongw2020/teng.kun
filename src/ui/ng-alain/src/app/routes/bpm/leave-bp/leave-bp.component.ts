    ...
    let columns: OsharpSTColumn[] = [
      {
        title: '操作', fixed: 'left', width: 65, buttons: [{
          text: '操作', children: [
            { text: '编辑', icon: 'edit', acl: 'Root.Admin.Bpm.LeaveBp.Update', click: row => this.edit(row) },
     ...
     // { title: '请假开始时间', index: 'LeaveStartTime', sort: true, editable: true, filterable: true, type: 'date' },
