...
export class LeaveVerifyComponent extends STComponentBase implements OnInit {
  ...
  protected GetSTColumns(): OsharpSTColumn[] {
    let columns: OsharpSTColumn[] = [
      ...
      //{ title: '请假开始时间', index: 'LeaveStartTime',readOnly: true, sort: true, editable: true, filterable: true, type: 'date' },
      //{ title: '请假结束时间', index: 'LeaveEndTime', readOnly: true,sort: true, editable: true, filterable: true, type: 'date' },
