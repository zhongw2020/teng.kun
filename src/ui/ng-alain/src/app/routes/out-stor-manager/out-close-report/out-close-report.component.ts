...
import { STData, STChange } from '@delon/abc';
import { AjaxResult } from '../../../shared/osharp/osharp.model';

@Component({
  selector: 'app-out-stor',
  templateUrl: './out-close-report.component.html',
  styles: []
})
export class OutCloseReportComponent extends STComponentBaseMatreport implements OnInit {
  ...
  doall(): void {
    ...
    let  url = 'api/admin/outStor/UpdateCloseAll';
